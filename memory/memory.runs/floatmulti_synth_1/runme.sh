...
HD_PWD='C:/Users/micha/Documents/UCT/HPES/YODA/memory/memory.runs/floatmulti_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floatmulti.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floatmulti.tcl
