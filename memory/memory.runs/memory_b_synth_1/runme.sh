...
HD_PWD='C:/Users/micha/Documents/UCT/HPES/YODA/memory/memory.runs/memory_b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memory_b.tcl
